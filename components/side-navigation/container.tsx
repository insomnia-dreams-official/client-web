...
const items = [
    ...
    {
        id: 3, name: 'Бумажная продукция', link: 'bumajnai_productia', subItems: [
            {id: 1, name: 'Бумажная продукция', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 4, name: 'Бытовая химия', link: 'butovai_himia', subItems: [
            {id: 1, name: 'Бытовая', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 5, name: 'Канцелярские товары', link: 'kanchelrskie_tovari', subItems: [
            {id: 1, name: 'Канцелярские', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 6, name: 'Одноразовая посуда', link: 'odonrazova', subItems: [
            {id: 1, name: 'Одноразовая', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 7, name: 'Украшение для стола', link: 'ukrashenia', subItems: [
            {id: 1, name: 'Украшение', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 8, name: 'Упаковочные материалы', link: 'upakova_tovari', subItems: [
            {id: 1, name: 'Упаковочные', link: 'subcategory_from_nav'}
        ]
    },
    {
        id: 9, name: 'Хозяйственные товары', link: 'hozistvennie_tovari', subItems: [
